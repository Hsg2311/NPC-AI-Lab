...
| 전이 대상 | 조건 |
|---|---|
| `Chase` | `dist > attackRange_ × 1.2` |
| `AttackRecover` | `windupTimer_ ≥ 0.4s` (데미지 적용, 타겟 생존) |
...
| `repositionRadius` | 3.0 | Reposition 시 타겟 주변 궤도 반경 |
